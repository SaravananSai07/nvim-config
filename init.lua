...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sD', function()
        builtin.diagnostics { scope = 'workspace' }
      end, { desc = '[S]earch [D]iagnostics in Workspace' })
      ...
      end, { desc = '[S]earch [a]ll files (incl dot and ignored files)' })
    end,
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'go', 'python', 'javascript', 'rust', 'toml', 'ron' },
